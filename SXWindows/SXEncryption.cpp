...
vector<uint8_t> SXEncryption::calculateRealUsername(bool flag)
{
	vector<sxbyte> PIN;
	if (flag) {
...
void SXEncryption::raiseVpn(bool flag)
{
	VpnUtils::createVpn("zstuvpn", calculateRealUsername(flag), passwd, server);
}
